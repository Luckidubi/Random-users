...
export default function TestErrorBoundary() {
  ...
  return (
    ...
    <>
      ...
      <Box h="100vh" maxW="1120px"  w={{base:360, sm:400, md: 780, lg: 1200, xl: 1400}}>
      <ErrorBoundary
    ...
    >
        ...
        <Flex direction="column" justify="center" gap={6}  p={5} alignItems="center" h="100%">
          ...
          <Button onClick={handleDisaster} variant="outline" _hover={{ cursor: 'pointer', bg:"red.400" }}>
              Danger
            </Button>
          </Box>
